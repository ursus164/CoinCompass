...
2. **Build the Project**:
   ...
   ## Usage
In this version app is using free CoinGecko Api key. So there is the query limit for the server. If you have your own API key and want to use it, you will have to individually change that in classes responsible for fetching market data and charts. In the future updates, I will add option to simply type private key, and all the neccessary changes in the source code will be done automatically.
